<?php
$pageTitle = 'Modifier le Projet - AlgoCodeBF';
...
<section class="create-project-section">
    <div class="container">
        ...
        <div class="page-header-create">
            ...
            <a href="<?= BASE_URL ?>/project/show/<?= $project['id'] ?>" class="btn-back">
                <i class="fas fa-arrow-left"></i> Retour au projet
            </a>
        </div>

        <?php if (!empty($errors)): ?>
            <div class="alert alert-danger" style="background: #f8d7da; border: 2px solid #dc3545; color: #721c24; padding: 15px 20px; border-radius: 12px; margin-bottom: 25px;">
        ...
        <div class="create-project-wrapper">
            <!-- Main Form -->
            <div class="form-main">
                <form action="<?= BASE_URL ?>/project/edit/<?= $project['id'] ?>" method="POST" class="project-form">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <div class="textarea-footer">
                                <span class="char-counter" id="charCounter"><?= strlen($old['description'] ?? '') ?> caractères (min: 20)</span>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="checkbox-card">
                                <input type="checkbox" 
                                       ...
                                       <?= (isset($old['looking_for_members']) && $old['looking_for_members']) || (!isset($old['looking_for_members']) && $project['looking_for_members']) ? 'checked' : '' ?>>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="<?= BASE_URL ?>/project/show/<?= $project['id'] ?>" class="btn-cancel">
            ...
            <aside class="tips-sidebar">
                <div class="tip-card">
                    ...
                    <ul class="tips-list">
                        <li>
                            ...
                            Mettez à jour régulièrement le statut
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                        ...
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Partagez les liens GitHub et démo
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            Activez la recherche de membres si besoin
                        </li>
                    </ul>
                </div>
                ...
                <div class="tip-card stats-card">
                    ...
                    <div class="stats-info">
                        <div class="stat-item">
                            <span class="stat-value"><?= date('d/m/Y', strtotime($project['created_at'])) ?></span>
                            <span class="stat-label">Date de création</span>
                        </div>
                        <div class="stat-item">
                            <span class="stat-value"><?= date('d/m/Y', strtotime($project['updated_at'] ?? $project['created_at'])) ?></span>
